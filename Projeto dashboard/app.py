...
FALLBACK_DATA_FILE = BASE_DIR / "dataset_tratado.csv"
...
def atualizar_dashboard(generos, treinos, faixa_idade, faixa_intensidade, perfis_sono):
    ...
    fig_disp = px.scatter(
        ...
        opacity=0.72,
        title="Dispersao: calorias consumidas x variacao de peso",
    ...
    fig_box = px.box(
        ...
        title="Distribuicao da variacao de peso por tipo de treino",
    ...
    fig_faixa = px.bar(
        ...
        barmode="group",
        text_auto=".3f",
        title="Media de variacao de peso por faixa etaria e genero",
    ...
    fig_sono = px.violin(
        ...
        box=True,
        points=False,
        title="Perfil de sono e distribuicao da variacao de peso",
    ...
    fig_corr_top = px.bar(
        ...
        color="Correlacao",
        text_auto=".2f",
        title="Top correlacoes (modulo) com Weight_Change",
        color_continuous_scale=[[0.0, "#7F1D1D"], [0.5, "#F8FAFC"], [1.0, "#0F766E"]],
    )
